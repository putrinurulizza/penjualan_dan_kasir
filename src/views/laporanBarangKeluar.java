...
public class laporanBarangKeluar extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","ID Transaksi","Kasir","Tanggal Transaksi","Total Bayar"};
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String kasir = hasil.getString("kasir");
                String total_bayar = hasil.getString("total_bayar");
                String[] data = {"",id_transaksi,tgl_transaksi,kasir,total_bayar};
                tabmode.addRow(data);
                noTable();
                lebarKolom();
            }
