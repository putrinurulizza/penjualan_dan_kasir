...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setFont(new java.awt.Font("Californian FB", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtusername.getText().equals("")){
            JOptionPane.showMessageDialog(null,"BEK TEUNGET BANG");
            txtusername.requestFocus();
        }
        else if (txtpaswoord.getText().equals("")){
            JOptionPane.showMessageDialog(null,"BEK TEUNGET BANG");
            txtpaswoord.requestFocus();
        }
        else if (txtusername.getText().contains("admin")&& txtpaswoord.getText().contains("1 2 3")){
            new fromlaporan().show();
            this.dispose();
        }
        else{
            JOptionPane.showMessageDialog(null,"ABANG GANTENG DEH");
